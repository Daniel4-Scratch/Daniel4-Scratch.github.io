...
var template = function(name, body) {
  ...
  document.body.innerHTML += '<div class="footer">  <p>    © Danielthebanana4 2020 <br />    <a href="Https://github.com/Daniel4-Scratch">Github</a> |    <a href="Https://glitch.com/@db4">Glitch</a>  </p></div>';
  
  if (donotdisturb) {
    document.body.innerHTML =
      "Sorry, My home wepbage is down, but you can still acsess the inedx page";
  }
};
